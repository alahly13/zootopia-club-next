...
function resolveProfileState(input: {
  ...
  const phoneMetadata = completion.normalizedPhoneNumber
    ...
    : null;
  const resolvedPhoneCountryIso2 = completion.normalizedPhoneVerifiedAt
    ? phoneMetadata?.countryIso2 ?? input.phoneCountryIso2 ?? null
    : null;
  const resolvedPhoneCountryCallingCode = completion.normalizedPhoneVerifiedAt
  ...
  return {
    ...
    phoneVerifiedAt:
      completion.normalizedPhoneVerifiedAt ?? input.phoneVerifiedAt ?? null,
